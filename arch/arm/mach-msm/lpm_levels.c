...
static struct of_device_id cpu_modes_mtch_tbl[] __refdata = {
...
static struct of_device_id system_modes_mtch_tbl[] __refdata = {
...
static struct of_device_id lpm_levels_match_table[] __refdata = {
